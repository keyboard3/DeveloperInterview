...
# in /Users/ganchunyu/Library/Android/sdk/tools/proguard/proguard-android.txt
...
-keep class de.greenrobot.event.SubscriberMethodFinde.* { *; }
-keep class org.joda.time.* { *; }

#module
-keep class com.werb.mediautilsdemo.* { *; }
#-------------------------------------------------------------------------

...
public abstract class AVersionService extends Service implements DownloadListener {
    ...
    private void verfiyAndDeleteAPK() {
        ...
        String downloadPath = versionParams.getDownloadAPKPath() + getApplicationContext().getString(R.string.versionchecklib_download_apkname, DownloadManager.getApkName(this));
